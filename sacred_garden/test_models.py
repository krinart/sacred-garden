...
class TestCreateEmotionalNeedState(TestCase):
    ...
    def test_simple(self):
        ...
        models.create_emotional_need_state(self.user, self.user_eneed, -2, 0, 0, "", "")
        self.assertEmotionalNeedValues(self.user_eneed, [(None, -2)])
        self.assertEmotionalNeedValues(self.partner_eneed, [])

        models.create_emotional_need_state(self.user, self.user_eneed, -1, 0, 0, "", "")
        ...
        models.create_emotional_need_state(self.user, self.user_eneed, 0, 0, 0, "", "")
