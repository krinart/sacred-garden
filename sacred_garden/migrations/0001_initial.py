# Generated by Django 4.1.7 on 2023-04-02 01:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.IntegerField(choices=[(0, 'Good'), (-10, 'Bad'), (-20, 'Problem')])),
                ('trend', models.IntegerField(choices=[(-1, 'Negative'), (0, 'Neutral'), (1, 'Positive')])),
