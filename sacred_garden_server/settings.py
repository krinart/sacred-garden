"""
Django settings for sacred_garden_server project.
...
SECRET_KEY = SECRET_KEY = os.environ.get(
    "SECRET_KEY", 'django-insecure-hp-l2f#yv5h+ks7ub8j(0^5mz13yl!&a0m!q_)i0^+f^ir7i*#')
...
ROOT_URLCONF = 'sacred_garden_server.urls'
...
WSGI_APPLICATION = 'sacred_garden_server.wsgi.application'
...
AWS_ACCESS_KEY_ID = 'AKIAWC7VALC3AJSCHSKH'
AWS_SECRET_ACCESS_KEY = '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'
